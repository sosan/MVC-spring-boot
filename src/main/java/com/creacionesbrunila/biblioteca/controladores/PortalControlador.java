...
@Controller
@RequestMapping("/")//va configurar cual es la url que va escuchar a este controlador
public class PortalControlador {
    ...
    @GetMapping("/login")
    public String login(@RequestParam(required = false) String error, ModelMap modelo) {//puede o no estar requerido que significa que puede venir o no un error 
    ...
    @GetMapping("/inicio")//hay que crear un controlador para esta vista sino da un 404
    public String inicio(HttpSession sesion) {
        Usuario logueado = (Usuario) sesion.getAttribute("usuariosession");//necesito castearlo 
